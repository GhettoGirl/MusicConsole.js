...
{
    for (const i of this.m_kanamap.hiragana)
    {
        if (c == i)
        {
            return true;
...
{
    for (const i of this.m_kanamap.katakana)
    {
        if (c == i)
        {
            return true;
...
{
    for (const i of this.m_kanamap.halfwidth)
    {
        if (c == i)
        {
            return true;
...
toHiragana: function(string)
{
    ...
    for (let i = 0; i < buf.length; i++)
    {
        ...
        {
            buf = jsext.String.replaceAt(buf, i,
                      this.m_kanamap.hiragana[this.m_kanamap.katakana.indexOf(buf[i])]);
        }

        else if (this.isHalfwidth(buf[i]))
        {
            buf = jsext.String.replaceAt(buf, i,
                      this.m_kanamap.hiragana[this.m_kanamap.halfwidth.indexOf(buf[i])]);
        }
    }
...
toKatakana: function(string)
{
    ...
    for (let i = 0; i < buf.length; i++)
    {
        ...
        {
            buf = jsext.String.replaceAt(buf, i,
                      this.m_kanamap.katakana[this.m_kanamap.hiragana.indexOf(buf[i])]);
        }

        else if (this.isHalfwidth(buf[i]))
        {
            buf = jsext.String.replaceAt(buf, i,
                      this.m_kanamap.katakana[this.m_kanamap.halfwidth.indexOf(buf[i])]);
        }
    }
...
toHalfwidth: function(string)
{
    ...
    for (let i = 0; i < buf.length; i++)
    {
        if (this.isHiragana(buf[i]))
        {
            ...
            {
                buf = jsext.String.replaceAt(buf, i,
                          this.m_kanamap.halfwidth[this.m_kanamap.hiragana.indexOf(buf[i])]);
            }
        }
        ...
        else if (this.isKatakana(buf[i]))
        {
            ...
            {
                buf = jsext.String.replaceAt(buf, i,
                          this.m_kanamap.katakana[this.m_kanamap.katakana.indexOf(buf[i])]);
            }

            else
            {
                buf = jsext.String.replaceAt(buf, i,
                          this.m_kanamap.halfwidth[this.m_kanamap.katakana.indexOf(buf[i])]);
            }
        }
    }
