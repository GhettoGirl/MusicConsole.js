...
method.find = function(search_term, media)
{
        ...
        search.containsKey(SearchPatternType.WithoutGenre))
    {
        ...
        for (var mediafile of filterlist)
        {
            for (var searchterm of mediafile.searchTerms())
            {
                // keyword filter
                for (var i = 0; i < without_any_of_this_keycount; i++)
                {
                ...
                // genre filter
                for (var i = 0; i < without_genre_keycount; i++)
                {
    ...
    for (var mediafile of searchlist)
    {
        for (var searchterm of mediafile.searchTerms())
        {
            for (var pattern of search.searchPatterns())
            {
