...
method.print = function()
{
    if (this.m_title == '')
    {
        global.printer.print_path(this.m_extension, this.m_album, this.m_album, this.m_title, this.m_genre,
                                  this.m_location.substr(0, this.m_location.length - this.m_extension.length - 1));
    }

    else
    {
        global.printer.print_tagged(this.m_extension, this.m_album, this.m_album, this.m_title, this.m_genre,
                                    this.m_location.substr(0, this.m_location.length - this.m_extension.length - 1));
    }
}
