...
{
    // check if the given object is a MediaFile instance
    ...
    // Default Player for media file type
    else if (typeof player == "undefined")
    {
        player = this.playerForMediatype(mediafile.m_type);
    }

    // Replace %f in argument list or append location if not existent
    var args = _.clone(player.arguments); // needs to be cloned, strange things happen otherwise
